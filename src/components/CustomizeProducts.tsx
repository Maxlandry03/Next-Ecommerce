        ...
        <div className="flex flex-col gap-6">
            {productOptions.map((option) => (
                ...
                {option.choices?.map((choice) => {
                    ...
                    return option.name === "Color" ? (<li className="w-8 h-8 rounded-full ring-1 ring-gray-300 relative" 
            ...
            </li>) : ( <li className="ring-1 ring-lama text-lama rounded-md py-1 px-4 text-sm "
